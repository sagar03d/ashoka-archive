...
<div class="filemgr-content">
    ...
    <div class="filemgr-content-body">
        <div class="card">
        @if(isset($subcollection))
            <form method="POST" action="{{ route('admin.subcollections.update', [$collection->id, $subcollection->id]) }}" id="add-form" data-redirect="{{route('admin.subcollections.index', $collection->id)}}">
            @method('PATCH')
        @else
            <form method="POST" action="{{ route('admin.subcollections.store', $collection->id) }}" id="add-form" data-redirect="{{route('admin.subcollections.index', $collection->id)}}">
        @endif
