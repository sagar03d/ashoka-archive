                ...
                <tbody>
                    @forelse($sliders as $slider)
                      <tr>
                        ...
                        <td><img class="pw" src="{{ asset($slider->path) }}"></td>
                        <td>
                            <button type="button" class="btn btn-sm btn-white btn-delete delete" data-action="{{ route('admin.sliders.destroy', $slider->id) }}"><i class="uil uil-trash-alt"></i>Delete</button>
                        </td>
                      </tr>
                    @empty
                        <tr>
...
<div class="modal fade effect-scale" id="addModal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <form method="POST" action="{{ route('admin.sliders.store') }}" id="add-form">
          <div class="modal-body pd-20 pd-sm-30">
            <button type="button" class="close pos-absolute t-15 r-20" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>

            <h5 class="tx-18 tx-sm-20 mg-b-20">New Slider</h5>
