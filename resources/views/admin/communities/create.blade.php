...
<div class="filemgr-content">
    <div class="filemgr-content-header d-sm-flex align-items-center justify-content-between">
        @if(isset($community))
            <h4 class="mg-b-0">Edit Community</h4>
        @else
            <h4 class="mg-b-0">Add Community</h4>
        @endif
    </div>
    ...
    <div class="filemgr-content-body">
        <div class="card">
        @if(isset($community))
            <form method="POST" action="{{ route('admin.communities.update', $community->id) }}" id="add-form" data-redirect="{{route('admin.communities.index')}}">
            @method('PATCH')
        @else
            <form method="POST" action="{{ route('admin.communities.store') }}" id="add-form" data-redirect="{{route('admin.communities.index')}}">
        @endif
            ...
            <div class="flex-fill">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-4 col-md-4">
                    <input type="text" name="name" value="{{$community->name??''}}" class="form-control" placeholder="Name">
                  </div>
              </div>
